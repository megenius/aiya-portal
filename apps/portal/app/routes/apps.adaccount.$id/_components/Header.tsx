        ...
        <div className="max-w-[85rem] flex justify-between lg:grid lg:grid-cols-2 basis-full items-center w-full mx-auto py-2.5 px-2 sm:px-6 lg:px-8">
          ...
          <div className="flex justify-end items-center gap-x-2">
            <div className="flex items-center">
              ...
              {/* Help Dropdown */}
              <div className="hidden hs-dropdown [--placement:adaccounttom-right] relative inline-flex">
                {/* Help Button Icon */}
                <button
                  id="hs-pro-dnhd"
                  type="button"
                ...
                >
                  ...
                  <div className="px-5 pt-3 flex justify-between items-center border-b border-gray-200 dark:border-neutral-800">
                    ...
                    >
                      <button
                        type="button"
                        className="hs-tab-active:after:bg-gray-800 hs-tab-active:text-gray-800 px-2 py-1.5 mb-2 relative inline-flex justify-center items-center gap-x-2 text-nowrap  hover:bg-gray-100 text-gray-500 hover:text-gray-800 text-sm rounded-lg disabled:opacity-50 disabled:pointer-events-none focus:outline-hidden focus:bg-gray-100 after:absolute after:-adaccounttom-2 after:inset-x-2.5 after:z-10 after:h-0.5 after:pointer-events-none dark:hs-tab-active:text-neutral-200 dark:hs-tab-active:after:bg-neutral-400 dark:text-neutral-500 dark:hover:text-neutral-300 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700 active "
            ...
            {/* Account Dropdown */}
            <div className="hs-dropdown inline-flex   [--strategy:absolute] [--auto-close:inside] [--placement:adaccounttom-right] relative text-start">
              <button
                id="hs-dnad"
                type="button"
          ...
          <div className="hidden lg:block">
            ...
            <div className="hs-dropdown [--auto-close:inside] [--placement:top-right] relative flex">
              ...
              <button
                ...
                aria-label="Dropdown"
              >
                <Avatar firstName={adaccount?.name as string} />
                <span className='ms-1'>{adaccount?.name}</span>
                <svg
              ...
              >
                <div className="p-1 space-y-0.5">
                  {adaccounts?.items?.map((adaccount, index) => (
                    <Link
                      key={index}
                      ...
                      to={`/apps/adaccount/${adaccount.id}`}
                    >
                      <div className='flex items-center gap-2'>
                        <Avatar
                          firstName={adaccount.name as string}
                        />
                        <span className='text-ellipsis'>{adaccount.name}</span>
                      </div>
                    </Link>
                  ))}
                </div>
