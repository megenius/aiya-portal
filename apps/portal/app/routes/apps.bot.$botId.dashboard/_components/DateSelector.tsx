...
const DateSelector: React.FC<DateSelectorProps> = ({ onDateChange }) => {
  ...
  return (
    <div className="hs-dropdown relative inline-flex">
      ...
      {isOpen && (
        <ul
          className="hs-dropdown-menu transition-[opacity,margin] duration-150 opacity-100 min-w-60 bg-white shadow-md rounded-lg mt-2 absolute right-0 top-full z-50 max-w-full"
          role="menu"
