...
import { useOrderbots } from '~/hooks/orderbot/useOrderbots';
...
const Header: React.FC<HeaderProps> = ({ bot }) => {
  ...
  const { data: bots } = useOrderbots({ variables: { workspaceId: bot?.team as string } })
  const navItems: NavItem[] = [
    ...
    { label: 'Settings', to: `/apps/orderbot/${botId}/settings` },
  ];
      ...
      <div className="bg-gray-800 border-b border-gray-700 dark:bg-black dark:border-neutral-800">
        <div className="max-w-[85rem] flex justify-between lg:grid lg:grid-cols-2 basis-full items-center w-full mx-auto py-2.5 px-2 sm:px-6 lg:px-8">
          <div className="flex items-center gap-x-3">
            <Link to={`/workspace/${workspace?.slug}/apps/orderbots`}>
              <LogoAiya colors={{
                path1: "white",
                path2: "white",
                path3: "white",
