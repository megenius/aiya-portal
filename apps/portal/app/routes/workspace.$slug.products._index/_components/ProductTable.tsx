                ...
                {items.map((item) => (
                  <tr>
                    <td className="size-px whitespace-nowrap ps-3 py-4">
                      <input
                        type="checkbox"
                        className="shrink-0 border-stone-300 rounded text-blue-600 focus:ring-blue-600 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-600 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-neutral-800"
                      />
                    </td>
                    <td className="size-px whitespace-nowrap px-4 py-3">
                      <div className="w-full flex items-center gap-x-3">
                        ...
                        <div className="grow">
                          <Link to={`${item.id}`}
                            className="text-sm font-medium text-stone-800 decoration-2 hover:underline focus:outline-none focus:underline  dark:text-neutral-200 dark:hover:text-blue-500 dark:focus:text-blue-500"
                          >
                            {item.name}
                          </Link>
