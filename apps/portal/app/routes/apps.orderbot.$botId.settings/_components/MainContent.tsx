...
const MainContent: React.FC<MainContentProps> = ({ children }) => {
  ...
  const navItems: NavItem[] = [
    { label: 'General', to: `/apps/orderbot/${botId}/settings` },
    // { label: 'Integrations', to: `/orderbot/${slug}/settings/integrations` },
    // { label: 'Plan & Billing', to: `/orderbot/${slug}/settings/plan` },
    // { label: 'Members', to: `/apps/orderbot/${botId}/settings/members` },
    { label: 'Information', to: `/apps/orderbot/${botId}/settings/information` },
    { label: 'Channels', to: `/apps/orderbot/${botId}/settings/channels` },
  ];
