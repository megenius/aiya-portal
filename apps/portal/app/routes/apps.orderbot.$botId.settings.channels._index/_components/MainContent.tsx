...
import { Orderbot, BotChannelStatus, WorkspaceChannel } from '~/@types/app';
import { useOrderbotChannels } from '~/hooks/orderbot/useOrderbotChannels';
...
const MainContent: React.FC<MainContentProps> = ({ bot }) => {
  const { data: channels } = useOrderbotChannels(bot.id as string);
