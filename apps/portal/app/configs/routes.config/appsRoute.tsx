...
const appsRoute: Routes = [
    ...
    // ============ Stocks =============
    {
        key: 'appsStocks.dashboard',
        path: `${APP_PREFIX_PATH}/stocks/dashboard`,
        component: lazy(() => import('@/views/stocks/StocksDashboard')),
        authority: [ADMIN, USER],
    },

    {
        key: 'appsStocks.beaconList',
        path: `${APP_PREFIX_PATH}/stocks/beacon-list`,
        component: lazy(() => import('@/views/stocks/BeaconList')),
        authority: [ADMIN, USER],
    },
    {
        key: 'appsStocks.beaconEdit',
        path: `${APP_PREFIX_PATH}/stocks/beacon-edit/:beaconId`,
        component: lazy(() => import('@/views/stocks/ProductEdit')),
        authority: [ADMIN, USER],
        meta: {
            header: 'Edit Product',
        },
    ...
    {
        key: 'appsStocks.productNew',
        path: `${APP_PREFIX_PATH}/stocks/beacon-new`,
        component: lazy(() => import('@/views/stocks/ProductNew')),
        authority: [ADMIN, USER],
        meta: {
    ...
    {
        key: 'appsSales.scrumBoard',
        path: `${APP_PREFIX_PATH}/sales/scrum-board`,
        component: lazy(() => import('@/views/sales/ScrumBoard')),
        authority: [ADMIN, USER],
        meta: {
            pageContainerType: 'gutterless',
        },
    ...
    {
        key: 'appsSales.test',
        path: `${APP_PREFIX_PATH}/sales/test`,
        component: lazy(() => import('@/views/pages/Test')),
        authority: [ADMIN, USER],
    },
    {
        key: 'appsSales.dealList',
        path: `${APP_PREFIX_PATH}/sales/deals`,
        component: lazy(() => import('@/views/sales/DealList')),
        authority: [ADMIN, USER],
    },
    {
        key: 'appsSales.dealDetails',
        path: `${APP_PREFIX_PATH}/sales/deal-details/:dealId`,
        component: lazy(() => import('@/views/sales/DealDetails')),
        authority: [ADMIN, USER],
    },
    {
