    ...
    <div className='w-full max-w-sm mx-auto'>
      <div className='fixed bottom-4 end-10'>
        ...
        <div className="hs-dropdown [--auto-close:inside] [--placement:bottom-right] relative inline-flex">
          ...
          {/* End Dropdown */}
          <button id="hs-pro-chwcnd" type="button" className="hs-dropdown-toggle flex justify-center items-center size-12 text-sm font-medium rounded-full border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-hidden focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown">
