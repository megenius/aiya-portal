      ...
      <div className="py-2 px-4 flex justify-between items-center gap-x-3 border-b border-gray-200">
        ...
        <div className="w-full">
          <div className="truncate flex items-center gap-x-2">
            <a className="flex-none rounded-md text-xl inline-block font-semibold focus:outline-none focus:opacity-80" href="../../pro/chat/index.html" aria-label="Preline">
        ...
        <div>
          {/* Button */}
          <button type="button" className="hs-dropdown-close flex justify-center items-center gap-x-3 size-8 text-sm text-gray-600 hover:bg-gray-100 rounded-full disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:bg-gray-100" aria-label="Close">
