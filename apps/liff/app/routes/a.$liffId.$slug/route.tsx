...
const Route = () => {
  ...
  /*
   * Page view tracking temporarily disabled per request.
   * To re-enable:
   * - import useEffect, useLocation, and useTrackUserEvent
   * - restore the useEffect block below to send "page_view" events
   */
