      ...
      <div className="bg-gradient-to-b from-blue-50 to-white">
              ...
              <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-10 sm:pt-12 md:pt-16 lg:pt-20 xl:pt-28">
                <div className="text-center">
                  ...
                  <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl md:text-7xl">
                    ...
                    <span className="block text-indigo-800">Engagement with AI</span>
                  </h1>
                  ...
                  <a href="#" className="text-base font-semibold leading-6 text-gray-900 flex items-center hover:text-indigo-800">
        ...
        <div className="bg-white py-12 hidden">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
              <div className="text-center">
                <div className="text-4xl font-bold text-indigo-800">10k+</div>
                <div className="mt-2 text-sm text-gray-600">Active Users</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-bold text-indigo-800">1M+</div>
                <div className="mt-2 text-sm text-gray-600">Messages/Month</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-bold text-indigo-800">95%</div>
                <div className="mt-2 text-sm text-gray-600">Customer Satisfaction</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-bold text-indigo-800">50+</div>
        ...
        <div className="bg-gray-50 py-24">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl lg:text-center">
              <h2 className="text-base font-semibold leading-7 text-indigo-800">Features</h2>
            ...
            <div className="mx-auto mt-16 max-w-7xl">
              <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div className="relative overflow-hidden rounded-2xl border border-gray-200 bg-white p-8 shadow-sm hover:shadow-md transition-shadow">
                  <Bot className="h-10 w-10 text-indigo-800" />
                ...
                <div className="relative overflow-hidden rounded-2xl border border-gray-200 bg-white p-8 shadow-sm hover:shadow-md transition-shadow">
                  <Globe className="h-10 w-10 text-indigo-800" />
                ...
                <div className="relative overflow-hidden rounded-2xl border border-gray-200 bg-white p-8 shadow-sm hover:shadow-md transition-shadow">
                  <BarChart3 className="h-10 w-10 text-indigo-800" />
                ...
                <div className="relative overflow-hidden rounded-2xl border border-gray-200 bg-white p-8 shadow-sm hover:shadow-md transition-shadow">
                  <Users className="h-10 w-10 text-indigo-800" />
                ...
                <div className="relative overflow-hidden rounded-2xl border border-gray-200 bg-white p-8 shadow-sm hover:shadow-md transition-shadow">
                  <Shield className="h-10 w-10 text-indigo-800" />
                ...
                <div className="relative overflow-hidden rounded-2xl border border-gray-200 bg-white p-8 shadow-sm hover:shadow-md transition-shadow">
                  <Zap className="h-10 w-10 text-indigo-800" />
        ...
        <div className="bg-white">
          <div className="mx-auto max-w-7xl px-6 py-24 sm:px-6 sm:py-32 lg:px-8">
            <div className="relative isolate overflow-hidden bg-gradient-to-r from-purple-900 to-indigo-800 px-6 py-24 text-center shadow-2xl rounded-3xl">
              ...
              {/* <div className="mt-10 flex items-center justify-center gap-x-6">
              <a href="" className="rounded-lg bg-white px-8 py-4 text-base font-semibold text-indigo-800 shadow-sm hover:bg-blue-50 transition-all">
