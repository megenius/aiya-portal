...
const appsNavigationConfig: NavigationTree[] = [
    {
        ...
        subMenu: [
            ...
            },
            {
                ...
                path: '',
                title: 'Stocks',
                translateKey: 'nav.appsStocks.stocks',
                icon: 'stocks',
                type: NAV_ITEM_TYPE_COLLAPSE,
                authority: [ADMIN, USER],
                subMenu: [
                    {
                        ...
                        title: 'Dashboard',
                        translateKey: 'nav.appsStocks.dashboard',
                        icon: '',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: [ADMIN, USER],
                        subMenu: [],
                    },
                    {
                        ...
                        title: 'Beacon List',
                        translateKey: 'nav.appsStocks.beaconList',
                        icon: '',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: [ADMIN, USER],
                        subMenu: [],
                    },
                    {
                        ...
                        path: `${APP_PREFIX_PATH}/stocks/beacon-edit/12`,
                        title: 'Beacon Edit',
                        translateKey: 'nav.appsStocks.beaconEdit',
                        icon: '',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: [ADMIN, USER],
                        subMenu: [],
                    ...
                    {
                        key: 'appsStocks.beaconNew',
                        path: `${APP_PREFIX_PATH}/stocks/beacon-new`,
                        title: 'New Beacon',
                        translateKey: 'nav.appsStocks.beaconNew',
                        icon: '',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: [ADMIN, USER],
                        subMenu: [],
            ...
            // ==================== Selas  =======================
            {
                ...
                subMenu: [
                    ...
                    },
                    {
                        ...
                        title: 'Deals Board',
                        translateKey: 'nav.appsSales.scrumBoard',
                        icon: '',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: [ADMIN, USER],
                        subMenu: [],
                    ...
                    },
                    {
                        ...
                        title: 'Test',
                        translateKey: 'nav.appsSales.test',
                        icon: '',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: [ADMIN, USER],
                        subMenu: [],
                    },
                    {
                        ...
                        title: 'Deals',
                        translateKey: 'nav.appsSales.dealList',
                        icon: '',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: [ADMIN, USER],
                        subMenu: [],
